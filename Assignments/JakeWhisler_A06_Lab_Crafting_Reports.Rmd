...
```{r ozone-2018, echo=FALSE, warning=FALSE, fig.height=2.5}
#| fig.cap="2018 Ozone",
#| fig.align = "left"
ozone2018 <- ggplot(subset(epa_data, Year == "2018"), aes(x = factor(Month), y = Ozone, group = Month)) +
  geom_boxplot() +
...
print(ozone2018)
```
```{r ozone-2019, echo=FALSE, fig.height=2.5, warning=FALSE}
#| fig.cap="2019 Ozone",
#| fig.align = "left"
ozone2019 <- ggplot(subset(epa_data, Year == "2019"), aes(x = factor(Month), y = Ozone, group = Month)) +
  geom_boxplot() +
  scale_x_discrete(labels=c("1" = "Jan", "2" = "Feb",
                              "3" = "Mar", "4" = "Apr",
                              "5" = "May", "6" = "Jun",
...
## Git Repository
[Jake Whisler's EDE Fall 2023 GitHub Repository (hyperlink)](https://github.com/jhwhis/EDE_Fall2023)
